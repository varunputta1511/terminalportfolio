...
function enterKey(e) {
  ...
  if (e.keyCode == 13) {
    ...
    git = commands.length;
    addLine("[varun@cgeTsec1511]~$" + command.innerHTML, "no-animation", 0);
...
function commander(cmd) {
  switch (cmd.toLowerCase()) {
    ...
    case "email":
      addLine(
        'Opening mailto:<a href="gmailto:varunputta1511@gmail.com"> varunputta1511@gmail.com</a>...',
        "color2",
        80,
      );
      newTab(email);
